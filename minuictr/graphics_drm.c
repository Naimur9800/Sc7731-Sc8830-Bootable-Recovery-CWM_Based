...
static drm_surface *drm_create_surface(int width, int height) {
    ...
    printf("setting DRM_FORMAT_RGBA8888 and GGL_PIXEL_FORMAT_RGBX_8888\n");
#elif defined(RECOVERY_BGRA)
    format = DRM_FORMAT_ARGB8888;
    base_format = GGL_PIXEL_FORMAT_RGBX_8888;
    printf("setting DRM_FORMAT_ARGB8888 and GGL_PIXEL_FORMAT_RGBX_8888, GGL_PIXEL_FORMAT may not match!\n");
    ...
    base_format = GGL_PIXEL_FORMAT_RGBX_8888;
    printf("setting DRM_FORMAT_XBGR8888 and GGL_PIXEL_FORMAT_RGBX_8888, GGL_PIXEL_FORMAT may not match!\n");
#else
